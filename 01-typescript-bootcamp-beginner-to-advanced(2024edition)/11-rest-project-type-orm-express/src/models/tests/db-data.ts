...
export const COURSES: any = {
    ...
    5: {
        ...
        iconUrl: 'https://my-web-app.s3.amazonaws.com/thumbnails/angular2-for-beginners-small-v2.png',
        category: 'BEGINNER',
        seqNo: 8,
    ...
    8: {
        ...
        iconUrl: 'https://my-web-app.s3.amazonaws.com/thumbnails/advanced_angular-small-v3.png',
        category: 'ADVANCED',
        seqNo: 15,
...
export const USERS = {
    1: {
        ...
        pictureUrl: 'https://my-web-app.s3.amazonaws.com/main-logo/main-page-logo-small-hat.png',
        isAdmin: false
    },
    2: {
        id: 2,
